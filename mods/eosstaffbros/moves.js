...
exports.BattleMovedex = {
	...
	"roomowner": {
		...
		priority: 0,
		flags: {charge: 1, nonsky: 1},
		onTryHit: function (attacker, defender, move) {
			if (attacker.removeVolatile(move.id)) {
				return;
			}
	...
	"quote": {
		...
		onHit: function (target, source) {
			...
			case 2:
				...
				break;
			case 3:
				this.add('c|#Safety Shark|"10/10 would bang Safety Shark" ~Cryptis 2015');
				this.runMegaEvo(target);
				this.boost({accuracy: -1});
				this.useMove('moonblast', target);
				this.useMove('aeroblast', target);
				this.useMove('fireblast', target);
				this.useMove('focusblast', target);
				this.boost({accuracy: 1});
				break;
			case 4:
				this.add('c|#Safety Shark|"Neo please control your BBC, it is running rampant in Delta." ~Cryptis 2015');
				this.useMove('safeguard', target);
				this.useMove('outrage', target);
				break;
			case 5:
				this.add('c|#Safety Shark|"dont yup me" ~Jzb 2015');
				this.useMove('taunt', target);
				this.useMove('disable', target);
			...
			case 6:
				...
				break;
			case 7:
				this.add('c|#Safety Shark|"When life gives you lemons, trade them for rocks." ~Hoot 2015');
				this.boost({def: 2});
				this.boost({spd: 2});
				this.useMove('batonpass', target);
				break;
			case 8:
				this.add('c|#Safety Shark|"Prepare your ani, Kray is Elite Four!" ~Kray 2015');
				this.runMegaEvo(target);
				this.useMove('focusenergy', target);
				this.boost({spe: 2});
				break;
			case 9:
				this.add('c|#Safety Shark|"Loosen your ani, people!" ~Kray 2015');
				this.useMove('infestation', target);
				this.useMove('toxic', target);
				break;
			case 10:
				this.add('c|#Safety Shark|"I\'ll just switch types!" ~Orion 2015');
				this.add('c|#Safety Shark|"Implying you\'re good at anything but Steel." ~Cryptis 2015');
				this.runMegaEvo(target);
				...
				break;
			case 11:
				this.add('c|#Safety Shark|"Welcome to Ghost. May I show you the door?" ~CGTNathan 2015');
				this.runMegaEvo(target);
				...
				this.useMove('shadowforce', target);
				break;
			case 12:
			...
			case 14:
				...
				break;
			case 15:
				this.add('c|#Safety Shark|"Lemon is a vegetable" ~CGTNathan 2015');
				this.runMegaEvo(target);
				this.add('-start', target, 'typechange', 'Dragon/Ground');
				target.typesData = [
					{type: 'Dragon', suppressed: false,  isAdded: false},
				...
				break;
			case 16:
				this.add('c|#Safety Shark|"I hate all of you" ~Ralker 2015');
				this.runMegaEvo(target);
				this.useMove('toxic', target);
				this.useMove('swagger', target);
				this.useMove('foul play', target);
				break;
			case 17:
				this.add('c|#Safety Shark|"I have the most logical mind you will ever meet." ~Masq 2015');
				this.runMegaEvo(target);
				this.useMove('infestation', target);
				this.useMove('willowisp', target);
				this.useMove('nightshade', target);
				break;
			case 18:
				this.add('c|#Safety Shark|"Holy faggotry!" ~Crystal League 2015');
				this.runMegaEvo(target);
				this.add('-start', target, 'typechange', 'Dragon/Ground');
				target.typesData = [
					{type: 'Dragon', suppressed: false,  isAdded: false},
