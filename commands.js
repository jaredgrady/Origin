...
global.developers = ['fender', 'nineage', 'irraquated', 'masterfloat', 'gnarlycommie', 'austin', 'sparkychild', 'aurastormlucario', 'charliekobayashi', 'niisama', 'duskull']; //sys developers
const developersIPs = [];
