...
var shop = [
    ...
    ['Icon', 'Buys a userlist icon that will show in 3 rooms.  (We will not change the rooms even if a fix is purchased. Will take time to appear as cache must reset for it to show)', 500]
];
