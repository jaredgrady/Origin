...
var shop = [
    ...
    ['Room', 'Buys a chatroom for you to own. (within reason, can be refused)', 150],
    ['Global Voice', 'Purchases global voice without need to be voted upon by staff. This can be revoked if abused.', 2500]
];
