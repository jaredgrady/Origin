...
exports.commands = {
	...
	joindice: function (target, room, user) {
		...
		if (!Db('money')[user.userid] || (Db('money')[user.userid] < room.dice.bet && !~developers.indexOf(user.userid))) return this.errorReply("You don't have enough bucks to join this game.");
