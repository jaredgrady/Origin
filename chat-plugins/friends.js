...
function getFriendList(user) {
	...
	var display = '<table style="width: 100%; border: 1px solid #803C6F; border-top-right-radius: 4px; border-top-left-radius: 4px; background: rgba(205, 159, 196, 0.7);"><tr><td>';
	var start = 0;
...
exports.commands = {
	...
	removefriend: function (target, room, user) {
		...
		if (Db('friends')[userid].indexOf(targetUser) > -1) {
			Db('friends')[userid].splice(targetUser, 1);
			Db.save();
