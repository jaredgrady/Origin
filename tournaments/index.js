...
class Tournament {
	...
	onTournamentEnd() {
		...
		if (this.room.isOfficial && tourSize >= 8 && Db('gangs').get(wid) !== '') {
			...
			this.room.addRaw("<b><font color='" + color + "'>" + Tools.escapeHTML(winner) + "</font> has also earned " + "<font color='" + color + "'>" + reward + "</font> points for the" + turfwars.gangs[gang].name + "<img src=" + turfwars.gangs[gang].icon + " width='50' height='50'</img> Gang!</b>");
		}
